...
const FeedbackCard = ({ feedback }) => {
	return (
		...
		>
			...
			<h3 className="text-2xl font-bold pt-20" style={{color:"#008F8C"}}>{feedback.name}</h3>
			<h4 className="text-lg font-bold text-gray-400" style={{color:"#0CABA8"}}>{feedback.title}</h4>
