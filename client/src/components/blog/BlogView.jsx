...
const BlogView = () => {
	...
	return (
		<div className="relative pb-20">
			...
			{loggedIn.role === "admin" && (
				<Link to="/createblogs">
					<IoAddCircle className=" cursor-pointer text-light-blue inline transform hover:scale-110 motion-reduce:transform-none w-28 h-28 fixed right-10 bottom-10" style={{color:"#023535"}} />
				</Link>
			)}
			<h1 className=" text-6xl font-bold text-white absolute top-56 right-20" style={{color:"#023535"}}>
				Our Blogs
			</h1>
