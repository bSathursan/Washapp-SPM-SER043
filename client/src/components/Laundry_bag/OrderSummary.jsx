...
const OrderSummary = () => {
	...
	return items.length ? (
		<div className="max-w-xl   ml-56     ">
			<div className=" pb-3 pt-3 text-center text-white text-xl mb-10" style={{background:"#023535"}}>
				<p>Order summary</p>
			</div>

			<div className="pt-20 pb-20 text-gray" style={{background:"#fafafa"}}>
							...
							<div className="relative w-auto my-6 mx-auto max-w-3xl">
								...
								<div className="border-0 ml-10 mr-10 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
									...
									<div className="items-start justify-between p-5 mt-20 rounded-t">
										<p className="text-2xl font-semibold  w-96 text-center text-light-blue ml-20 " style={{color:"#015958"}}>
											Please Enter pick up details
										</p>
										<br />
										<p className="mr-10 ml-40 text-gray-400 font-semibold " style={{marginTop:"-20px", color:"#0CABA8"}}>
									...
									<div className="relative p-6 flex-auto ml-auto mr-auto w-85" style={{marginTop:"-50px"}}>
										<form onSubmit={handleSubmit}>
											<div className="my-5 text-sm">
												<label className="block text-gray-400 font-semibold text-lg">
													Location :
												</label>
											...
											<div className="flex items-center justify-center p-6  rounded-b mt-10 mb-20">
												<button
													...
													style={{background:"#0FC2C0", color:"#fff"}}
												>
													Close
												</button>
												<button
