...
const ViewOrder = () => {
  ...
  return (
    <div className="flex flex-col ">
      <div className="flex mx-auto items-center justify-center shadow-lg  mb-4" style={{marginTop:"250px", marginLeft:"800px", background:"#fafafa"}}>
        <div className="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
          <h2 className="text-5xl font-extrabold pb-10 pt-10 text-center ml-8 " style={{color:"#015958"}}>
            Order View
          </h2>
