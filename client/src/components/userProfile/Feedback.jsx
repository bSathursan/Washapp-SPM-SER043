...
const Feedback = () => {
	...
	return (
		<div>
			...
			<div className="flex mx-auto items-center justify-center shadow-lg mb-4 max-w-lg" style={{background:"#fafafa", marginLeft:"800px", marginTop:"150px"}}>
				<form
				...
				>
					<div className="flex flex-wrap -mx-3 mb-6">
						<h2 className="text-5xl font-extrabold pb-10 pt-10 text-center" style={{color:"#015958", marginLeft:"130px"}}>
							Feedback
						</h2>
						<div className="w-full md:w-full px-3 mb-2 mt-2">
							<div className="flex flex-col justify-start pb-5 w-full">
								<label htmlFor="package-name" className="pb-1 text-gray-400">
									Category
								</label>
								<select
							...
							<div className="flex flex-col justify-start pb-5 w-full">
								<label htmlFor="package-topic" className="pb-1 text-gray-400">
									Topic
								</label>
								<input
							...
							<div className="flex flex-col justify-start pb-5 w-full">
								<label htmlFor="package-Description" className="pb-1 text-gray-400">
									Description
								</label>
								<input
						...
						<div className="w-full md:w-full flex items-start px-3">
							...
							<div className="-mr-1 space-x-4">
								<Link className="transition duration-500 ease-in-out py-3 px-5 bg-black hover:bg-light-blue text-white rounded-3xl transform hover:-translate-y-1 hover:scale-110" style={{background:"#008F8C"}}>
									Cancle
								</Link>
								<button
