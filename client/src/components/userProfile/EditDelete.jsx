  ...
  useEffect(() => {
	...
	return (
		<div style={{marginLeft:"400px"}}>
			...
			<div className=" absolute mx-auto shadow-lg sm:rounded-2xl sm:p-20 top-2  ml-96 my-8 w-full max-w-xl  rounded-lg px-4 pt-2 items-center justify-end" style={{background:"#fafafa"}}>
				<h1 className="text-5xl font-extrabold pb-10 text-center" style={{color:"#015958"}}>
					Edit profile
				</h1>
				...
				>
					<div className=" mb-4 " >
						<label className=" font-semibold text-24px text-gray-400" for="username">
							User Name
							<input
					...
					<div className="mb-4">
						<label className=" font-semibold text-24px text-gray-400" for="email">
							Email
							<input
								className=" outline-none rounded-full border px-4 py-3 focus:border-light-blue"
								id="email"
					...
					{/* <div className="mb-4">
            <label className=" font-semibold text-24px text-gray-400" for="password">
              Password
              <input
                className="outline-none rounded-full border px-4 py-3 focus:border-light-blue"
                id="password"
              ...
              />
					...
					<div className="mb-8">
						<label className=" font-semibold text-24px text-gray-400" for="mobile">
							Mobile
							<input
								className="outline-none rounded-full border px-4 py-3 focus:border-light-blue"
								id="mobile"
					...
					<div className="space-x-4 mb-4" style={{marginLeft:"180px"}}>
						<button
							...
							style={{background:"#023535", height:"40px", width:"150px"}}
						>
