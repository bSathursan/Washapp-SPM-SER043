	...
	return (
		<>
			{isLoading ? (
				...
				<div className="w-1/2 shadow-lg rounded-xl p-8 m-8 flex justify-between flex-wrap" style={{background:"#fafafa"}}>
					<p className="text-lg font-medium pt-2" style={{color:"#015958"}}>
