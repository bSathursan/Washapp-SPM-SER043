		...
		>
			{orders.length !== 0 ? (
				<div className="flex flex-col">
					<h3 className="text-center text-3xl mb-20 font-semibold " style={{color:"#015958"}}>
						Pick up order List
					</h3>
					...
					>
						...
						/>
						<button className="text-white absolute right-0 top-0 h-full rounded-full w-16 flex items-center justify-center font-bold text-2xl" style={{background:"#023535"}}>
							<BiSearch />
						</button>
						{searchQuery && (
							<div
				...
				<div className="font-semibold text-center text-blue-500 mb-80 mt-20 text-xl" style={{color:"#015958"}}> No orders found for pick up</div>
			)}
		</div>
	);
};
