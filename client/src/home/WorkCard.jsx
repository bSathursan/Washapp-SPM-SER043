...
const WorkCard = ({ work }) => {
	return (
		...
		>
			...
			<h3 className="text-2xl font-bold pt-10 pb-4 px-6" style={{color:"#008F8C"}}>{work.title}</h3>
			<p className="text-lg px-6 pb-8 text-gray-400 text-center text-justify">{work.description}</p>
		</div>
	);
};
