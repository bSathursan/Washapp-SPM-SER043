...
const Packages = () => {
	document.title = "WASHAPP - All Packages";
	...
	return (
		...
		// 				}}
		// 			/>
		// 			<button className="text-white absolute right-0 top-0 h-full rounded-full w-24 flex items-center justify-center font-bold text-2xl" style={{background:"#023535"}}>
		// 				<BiSearch />
		// 			</button>
		// 			{searchQuery && (
		// 				<div
