...
const AdminUpdatePackage = () => {
	document.title = "WASHAPP - Update Package";
						...
						<div className="px-16 flex justify-center w-full">
							...
							>
								...
								<div
									...
									data-aos="fade-up-left"
								>
									<label htmlFor="price" className="pb-1 text-gray-400">
										Package Price (LKR)
									</label>
									<input
										type="number"
								...
								<div className="flex justify-center">
									<button
										className="text-white py-4 px-14 rounded-full mt-8 font-semibold text-center"
										data-aos-delay="250"
										data-aos="zoom-in"
										data-aos-offset="50"
										style={{background:"#023535", marginTop:"-10px", fontSize:"20px"}}
									>
